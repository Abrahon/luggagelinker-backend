...
class TripTravelerSerializer(serializers.ModelSerializer):
    """
    Small public traveler information shown with a Trip.
    """
    ...
    #
    # IMPORTANT:
    # This is NOT User.is_verified.
    #
    # Traveler is identity verified only when:
    #
    # KYC.status == APPROVED
    # ==========================================================
...
class TripSerializer(serializers.ModelSerializer):
    ...
    traveler = TripTravelerSerializer(
        read_only=True
    )
    ...
    def validate(self, attrs):
        ...
        if (
            ...
            raise serializers.ValidationError(
                {
                    "max_weight_kg": (
                        "Maximum weight cannot be "
                        "less than available weight."
                    )
                }
            )
    ...
    def update(
        ...
        previous_max = (
            instance.max_weight_kg
        )

        previous_available = (
            instance.available_weight_kg
        )
