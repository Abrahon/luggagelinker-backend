...
from .views import SignupView,VerifyOTPView,AdminUserGrowthView,AdminUserListView,AdminUserStatusToggleView,LoginView,ResendOTPView,ForgotPasswordOTPView,VerifyForgotOTPView,ResetPasswordView
